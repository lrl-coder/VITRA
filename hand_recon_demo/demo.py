...
def save_hand_pose(recon_results: dict, output_path: str, total_frames: int):
    """
...
def main():
    ...
    if args.save_pose is not None:
        ...
        print("步骤 6: 保存手部位姿数据")
        print("="*60)
        save_hand_pose(recon_results, args.save_pose, total_frames=len(images))
